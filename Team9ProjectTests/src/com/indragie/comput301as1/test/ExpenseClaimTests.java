...
public class ExpenseClaimTests extends TestCase {
	...
	public void testDescriptionAccessors() {
		ExpenseClaim claim = new ExpenseClaim("Indragie", "Some description", new Date(), new Date(), new User("test_id", "Test User"), ExpenseClaim.Status.IN_PROGRESS);
	...
	public void testStartDateAccessors() {
		...
		ExpenseClaim claim = new ExpenseClaim("Indragie", "", currentDate, new Date(), new User("test_id", "Test User"), ExpenseClaim.Status.IN_PROGRESS);
	...
	public void testEndDateAccessors() {
		Date currentDate = new Date();
		ExpenseClaim claim = new ExpenseClaim("Indragie", "", new Date(), currentDate, new User("test_id", "Test User"), ExpenseClaim.Status.IN_PROGRESS);
